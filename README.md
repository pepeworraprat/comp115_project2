...
The program identifies CHSA areas in which more than 50% of renters spend 30% or more of their income on shelter costs and compares rental subsidy rates across the five PHA regions.
...
2. Install matplotlib (_pip3 install matplotlib_ insert in terminal)
3. Put the "BC Census 2016 data.csv" file in the same folder as the Python file
4. Run
